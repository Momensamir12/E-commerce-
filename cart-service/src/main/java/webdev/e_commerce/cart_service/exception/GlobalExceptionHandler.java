package webdev.e_commerce.cart_service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<APIResponse> internalServerErrorExceptionHandler(Exception ex) {
        log.error(ex.getLocalizedMessage(), ex);
        return createUnifiedResponse(null, HttpStatus.INTERNAL_SERVER_ERROR, DEFAULT_INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler(CartItemNotFoundException.class)
    public ResponseEntity<APIResponse> cartItemNotFoundExceptionHandler(CartItemNotFoundException ex) {
        return createUnifiedResponse(null, HttpStatus.NOT_FOUND, ex.getMessage());
    }

    @ExceptionHandler(CartNotFoundException.class)
    public ResponseEntity<APIResponse> cartNotFoundExceptionHandler(CartItemNotFoundException ex) {
        return createUnifiedResponse(null, HttpStatus.NOT_FOUND, ex.getMessage());
    }
