package webdev.e_commerce.payment_service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<APIResponse> handleStripeException(InvalidFormatException ex) {
        log.error("Error while processing your payment , please try again", ex);
        return createUnifiedResponse(null, BAD_REQUEST, ex.getMessage());
    }

    @ExceptionHandler(PaymentNotFoundException.class)
    public ResponseEntity<APIResponse> paymentNotFoundExceptionHandler(PaymentNotFoundException ex) {
        log.error(ex.getLocalizedMessage(), ex);
